...
<img src="LLM.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p> 
...
<img src="Ollamadownloadpage.png" width="500" style="vertical-align:middle;margin:0px 50px">  
...
<img src="Ollama.png" width="500" style="vertical-align:middle;margin:0px 50px"> 
<p>  </p>
 5. To download the Llama 3, paste the code in the terminal:

 ollama run llama3 

<img src="Llama3.png" width="500" style="vertical-align:middle;margin:0px 50px">  
<p>  </p>
...
10. Now in the browser we paste the url link: http://127.0.0.1:8000/llma 
 which provide the product name, description and price in JSON format.
...
<img src="webscarping_site.png" width="700" style="vertical-align:middle;margin:0px 50px">  

<p>  </p>
I used E-commerce site with AJAX pagination links. The E-commerce site with multiple categories, subcategories. Dynamic links that use data without reloading the page for pagination, such that in this program.
...
<img src="input_html.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>

Then after the steps are done to run the API, as mentioned above:

We get:

<img src="output_json.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>
...
<img src="swaggerUI.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>

Click on the Try it out and we see:

<img src="testing_api.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>

Click on Execute and we get:

<img src="validated_output_json.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>

So to sum it up, we can see the block diagram:

<img src="final_block_diagram.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>
...
<img src="example_input.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>
Output:

<img src="example_output.png" width="700" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>