...
<img src="webscarping_site.png" width="500" style="vertical-align:middle;margin:0px 50px">  
...
<img src="input_html.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>
...
<img src="output_json.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>
...
<img src="swaggerUI.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>

Click on the Try it out and we see:

<img src="testing_api.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>

Click on Execute and we get:

<img src="validated_output_json.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>

So to sum it up, we can see the block diagram:

<img src="final_block_diagram.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>
...
<img src="example_input.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>
Output:

<img src="example_output.png" width="500" style="vertical-align:middle;margin:0px 50px">       
<p>  </p>